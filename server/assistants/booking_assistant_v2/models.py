...
class BookingAssistantV2RunRequest(BaseModel):
...
class BookingAssistantV2RunItem(BaseModel):
    mail_id: str
    thread_id: str = ""
    subject: str = ""
    from_email: str = ""
...
class BookingAssistantV2RunResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
    run_id: str = ""
    started_at: str = ""
    ...
    review_count: int = 0
    skipped_count: int = 0
    items: List[BookingAssistantV2RunItem] = Field(default_factory=list)


class BookingAssistantV2ReviewItem(BaseModel):
    id: str
    status: str
    created_at: str
    updated_at: str = ""
...
class BookingAssistantV2ReviewsResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
    reviews: List[BookingAssistantV2ReviewItem] = Field(default_factory=list)


class BookingAssistantV2ApproveRequest(BaseModel):
    provider: str = Field(default="ionos")
    edited_body: str = ""
    subject: str = ""


class BookingAssistantV2RejectRequest(BaseModel):
    provider: str = Field(default="ionos")
    edited_body: str = ""
    subject: str = ""
...
class BookingAssistantV2CounterofferRequest(BaseModel):
    provider: str = Field(default="ionos")
    edited_body: str = ""
    subject: str = ""


class BookingAssistantV2ReviewActionResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
    review_id: str
    status: str
...
class BookingAssistantV2StatusMeetingResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
    since: str = ""
    generated_at: str = ""
...
class BookingAssistantV2PendingNextResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
...
class BookingAssistantV2PendingApplyRequest(BaseModel):
    provider: str = Field(default="ionos")
...
class BookingAssistantV2OperatorChatRequest(BaseModel):
    provider: str = Field(default="ionos")
    assistant_profile_name: str = Field(default="booking_default")
    message: str = Field(..., min_length=1)


class BookingAssistantV2OperatorChatResponse(BaseModel):
    ok: bool = True
    version: str = "2.0"
    intent: str = ""
    action_taken: str = ""
