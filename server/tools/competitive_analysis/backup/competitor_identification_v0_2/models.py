...
class CompetitorIdentificationRequest(BaseModel):
    ...
    min_similarity_score: float = Field(default=0.12, ge=0.0, le=1.0)
    url_priority_weight: float = Field(default=1.0, ge=0.0, le=3.0)
    datasheet_priority_weight: float = Field(default=0.6, ge=0.0, le=3.0)
