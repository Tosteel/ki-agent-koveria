...
- Technische Aufgabe: Alle Imports aus dem `backup`-Ordner schrittweise aufloesen und auf die produktiven v0_5-Module migrieren (keine Runtime-Abhaengigkeit mehr auf `server/tools/competitive_analysis/backup/*`).
