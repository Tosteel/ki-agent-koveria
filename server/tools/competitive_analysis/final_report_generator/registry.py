...
TOOL_NAME = "competitive_generate_final_report"


def register(registry: ToolRegistry) -> None:
    def tool_final_report(ctx: ToolContext, args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    registry.register(TOOL_NAME, tool_final_report, request_model=FinalReportRequest)
