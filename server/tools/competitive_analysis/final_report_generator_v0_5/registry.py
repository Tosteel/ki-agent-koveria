...
from .final_report_generator_v0_5 import build_final_report_v0_5
from .models import FinalReportRequest, FinalReportResponse


TOOL_NAME = "final_report_generator_v0_5"


def register(registry: ToolRegistry) -> None:
    def tool_final_report_v0_5(ctx: ToolContext, args: Dict[str, Any]) -> Dict[str, Any]:
        req = FinalReportRequest(**args)
        result = build_final_report_v0_5(
    ...
    registry.register(TOOL_NAME, tool_final_report_v0_5, request_model=FinalReportRequest)
