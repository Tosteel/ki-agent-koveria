...
_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "llm_text_compose": "Text in eine kohärente Antwort umformulieren.",
    ...
    "distance_check": "Entfernung/Fahrzeit zwischen zwei Orten prüfen.",
    "pricing_compute_quote": "Preisangebot aus Dauer, Distanz und Regeln berechnen.",
    ...
    "calender_hold_event": "Vorläufigen Kalender-Hold anlegen (Alias).",
